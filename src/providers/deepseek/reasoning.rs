...
use super::super::reasoning_blob::decode_reasoning_content;

#[derive(Debug, Default)]
pub(in crate::providers) struct RequestReasoning {
...
pub(in crate::providers) fn inject_reasoning_content(
...
pub(in crate::providers) fn collect_reasoning_from_responses_input(
    reasoning: &mut RequestReasoning,
...
pub(in crate::providers) fn collect_reasoning_from_anthropic_input(
    reasoning: &mut RequestReasoning,
...
pub(in crate::providers) fn collect_reasoning_from_gemini_input(
    reasoning: &mut RequestReasoning,
...
pub(in crate::providers) fn strip_anthropic_reasoning_content_blocks(chat_request: &mut Value) {
    let Some(messages) = chat_request
        .get_mut("messages")
        .and_then(Value::as_array_mut)
    else {
